...
EXPORT_DIR = "archives/"
EXPORT_PATH = EXPORT_DIR+"download/"
...
if DEPLOY:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': 'stash',                      # Or path to database file if using sqlite3.
...
FILE_UPLOAD_MAX_MEMORY_SIZE = 500000000 #500MB
...
try:
    SECRET_KEY = open(os.path.join(BASE_DIR, 'secretkey.txt')).readline().strip()
except:
