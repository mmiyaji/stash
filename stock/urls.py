...
urlpatterns = patterns('',
                       ...
                       url(r'^photo/$', 'stock.entry.home'),
                       url(r'^photo/(?P<entry_uuid>\w{32})/$', 'stock.entry.detail'),
                       url(r'^photo/(?P<entry_uuid>\w{32})/delete/$', 'stock.entry.delete'),
                       url(r'^photo/(?P<entry_uuid>\w{32})/update/$', 'stock.entry.update'),
                       url(r'^photo/(?P<entry_uuid>\w{32})/rotate/$', 'stock.entry.rotate'),
